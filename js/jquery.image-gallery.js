...
(function (factory) {
    ...
    $.widget('blueimp.imagegallery', {
        ...
        _loadHandler: function (img) {
			...
			var permlink = this._link.rel.split('|')[1];
			var footer = $('<div class="ui-dialog-footer"></div>');


			var fblike = '<div class="fblike"><div class="fb-like" data-href="';
			fblike += permlink;
			fblike += '" data-layout="button_count" data-width="450" data-show-faces="false"></div>';
			fblike += '</div>';
			//var fblike = '<div class="fblike"><div class="fb-like" data-href="http://www.zubinraj.com/photos/portfolio/" data-send="false" data-width="450" data-show-faces="true" data-colorscheme="dark"></div></div>';
			
			footer.append(fblike);

			footer.append('<div class="ui-dialog-footer-title">' + this._link.title + '</div>');
			
			footer.append('<div style="clear:both" />');
